...
FUNCTIONS = {
    ...
    "add_2": ("int->int", lambda x: (x + x), "add {0} {0}"),
    "add_3": ("int->int", lambda x: (x + (1 + (1 + (1 + (1 + (1 + (1 + 1))))))), "add {0} (add i1() (add i1() (add i1() (add i1() (add i1() (add i1() i1()))))))"),
    ...
    "sub_4": ("int->int", lambda x: ((x + x) - (1 + (1 + 1))), "sub (add {0} {0}) (add i1() (add i1() i1()))"),
}
