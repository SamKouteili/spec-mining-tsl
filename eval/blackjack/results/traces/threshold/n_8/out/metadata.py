...
FUNCTIONS = {
    ...
    "sub": ("int->int", lambda x: ((x + x) - (1 + (1 + (1 + (1 + 1))))), "sub (add {0} {0}) (add i1() (add i1() (add i1() (add i1() i1()))))"),
    "sub_2": ("int->int", lambda x: ((x + x) - (1 + (1 + (1 + (1 + (1 + 1)))))), "sub (add {0} {0}) (add i1() (add i1() (add i1() (add i1() (add i1() i1())))))"),
    "sub_3": ("int->int", lambda x: ((x + x) - (1 + 1)), "sub (add {0} {0}) (add i1() i1())"),
    "sub_4": ("int->int", lambda x: ((x + x) - (1 + (1 + (1 + 1)))), "sub (add {0} {0}) (add i1() (add i1() (add i1() i1())))"),
}
